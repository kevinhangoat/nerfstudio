...
from scripts.read_write_model import binary_to_txt
...
if __name__ == "__main__":
    ...
    if args.hold <= 0:
        ...
        write_json(os.path.join(OUT_PATH, 'transforms.json'), frames)
        ...
        write_json(os.path.join(OUT_PATH, 'transforms_train.json'), frames_train)
        write_json(os.path.join(OUT_PATH, 'transforms_val.json'), frames_test[::10])
        write_json(os.path.join(OUT_PATH, 'transforms_test.json'), frames_test)
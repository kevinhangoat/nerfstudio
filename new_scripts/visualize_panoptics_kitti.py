...
if __name__ == "__main__":
    ...
    pan_dir = "/srv/beegfs02/scratch/bdd100k/data/sfm/nerfstudio_data/data/KITTI-360-raw-single/pan_mask/semantics/"
    save_dir = "/srv/beegfs02/scratch/bdd100k/data/sfm/nerfstudio_data/data/KITTI-360-raw-single/pan_mask/vis"
    img_dir_00 = "/srv/beegfs02/scratch/bdd100k/data/sfm/nerfstudio_data/data/KITTI-360-raw-single/images/image_00/data_rect"
    img_dir_01 = "/srv/beegfs02/scratch/bdd100k/data/sfm/nerfstudio_data/data/KITTI-360-raw-single/images/image_01/data_rect"
    for sem_file in tqdm(os.listdir(pan_dir)):
        ...
        if sem_file[:2] == "00":
            img_path = os.path.join(img_dir_00, sem_file.replace("00_", ""))
        if sem_file[:2] == "01":
            img_path = os.path.join(img_dir_01, sem_file.replace("01_", ""))

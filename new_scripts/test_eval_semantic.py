...
def _render_results(
    ...
    for camera_idx in range(cameras.size):
        ...
        # pdb.set_trace()
        # np.save(outputs["semantics"].cpu().numpy(), "/srv/beegfs02/scratch/bdd100k/data/sfm/nerfstudio_data/outputs/11216_3/semantic-nerfacto/2023-02-15_120959/semantics.npy")

...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--change-appearance",
        action="store_true",
        help="If you want to change appearance embedding",
    )
    ...
    if (args.change_appearance):
        pipeline.model.use_average_appearance_embedding = False
        pipeline.model.use_min_appearance_embedding = True
    _render_results(
        pipeline,
